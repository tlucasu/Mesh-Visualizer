...
namespace MeshVisualizer.Controller {
    public class LightingController : MonoBehaviour {
        ...
        [Header("Default Skybox")] public Material defaultSkybox;

        [ColorUsage(false, true)] [InspectorName("Ambient Light")]
        public Color defaultSkyboxAmbientLight = Color.gray;

        [InspectorName("Directional Light")] public Light defaultDirectionalLight;
        ...
        [InspectorName("Directional Light")] public Light darkDirectionalLight;

        [Header("No Skybox")] [InspectorName("Ambient Light")] [ColorUsage(false, true)]
